export default class Map {
    ...
    saveSettings(settings) {
        ...
        if(settings.map_width) { this.width = settings.map_width; }
        if(settings.map_height) { this.height = settings.map_height; }
        if(settings.map_name) { this.name = settings.map_name; }
