export default class Grid {
    ...
    saveSettings(settings) {
        ...
        if(settings.grid_width) { this.gridSize.x = parseInt(settings.grid_width); }
        if(settings.grid_height) { this.gridSize.y = parseInt(settings.grid_height); }
        if(settings.grid_color) { this.color = settings.grid_color; }
